...
const char* ssid = "Uvan";             //Add your WiFi ssid
const char* password =  "aaaaaaaa";    //Add your WiFi password

String apiKey = "1906326";              //Add your Token number that bot has sent you on WhatsApp messenger
String phone_number = "+919080224585"; //Add your WhatsApp app registered phone number (same number that bot send you in url)
